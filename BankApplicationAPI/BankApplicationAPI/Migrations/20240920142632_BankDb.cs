    ...
    public partial class BankDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "C111111", "9876543210", "Mumbai", null, null, "sanjeev", "kumar", "sanjeev@example.com", null, false, null, "$2a$11$vlUAbd34pLEk79dBUH.Cz.3GwbjPEgCecw9fvXkQ1Me04KJes99R6", "Maharashtra", null, "10001" },
                    { "C111112", "9876543212", "Kolkata", null, null, "sanjay", "ray", "sanjay@example.com", null, false, null, "$2a$11$1fb162AGQbZaJMPolr/Fz.jUY9yZdHn3RsV7SdC62yzh8ba76okma", "west bengal", null, "90001" },
                    { "C111113", "9876543213", "Chennai", null, null, "kumar", "reddy", "kumar@example.com", null, false, null, "$2a$11$/4xNHXyjRW/zvE4YLKA8cupoYuNs.6gRdk1Qn2wlgL1gH71tcb3ii", "Tamilnadu", null, "60601" },
                    { "C111114", "9876543214", "Kadapa", null, null, "jay", "kumar", "jay@example.com", null, false, null, "$2a$11$jr8D7Gz7n/VSDmHwrx7lPOEidb3nTz4MXBaLOOcoSGr3CZ87Feqaq", "Andhra pradesh", null, "77001" },
                    { "C111115", "9876543215", "Amaravathi", null, null, "pavan", "kumar", "pavan@example.com", null, false, null, "$2a$11$I9Mar507Q5NADdz72uapnuvufc8MRCwXR3lWUIy9jDVc61lKUcIFG", "Andhra pradesh", null, "85001" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "E111111", "Amit@example.com", "Amit", "Sharma", false, null, "$2a$11$SubYO3/iRUCHZTzxCPG.N.Z0SfwRWq/dpdP1cHs8Wo7TQKdAmVMZW" },
                    { "E111112", "Neha@example.com", "Neha", "Patel", false, null, "$2a$11$8l7RvAGNe1Zrp6ymfsTFXOEQiyFd4.f1r9mjURfBYUNY71pbtvtQy" },
                    { "E111113", "Raj@example.com", "Raj", "Kumar", false, null, "$2a$11$.HWdvdB41VsMNoXXkqmuy.awMCF4gkAchUBf0ApiROWsDlQrqQChu" },
                    { "E111114", "Priya@example.com", "Priya", "Desai", false, null, "$2a$11$MB9roPHtXMkyBXizOqQWdeFLtvqoWm2m/.U2n44BC3yHBF4jVIvyu" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "User Login", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5839), "User logged in successfully", "E111111", "192.168.1.1" },
                    { 2, "Password Reset", new DateTime(2024, 9, 20, 19, 46, 31, 353, DateTimeKind.Local).AddTicks(5845), "Password reset for user John", "E111111", "192.168.1.2" },
                    { 3, "Created New User", new DateTime(2024, 9, 20, 18, 56, 31, 353, DateTimeKind.Local).AddTicks(5851), "Admin created a new user", "E111111", "192.168.1.3" },
                    { 4, "Failed Login Attempt", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5856), "User failed login attempt", "E111111", "192.168.1.4" },
                    { 5, "Deleted Account", new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5861), "Admin deleted user account", "E111112", "192.168.1.5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4408), "Issue with transaction", "Open", 1, "C111111", "E111111", null, "Pending", null },
                    { 2, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4440), "Incorrect charge", "Resolved", 2, "C111112", "E111112", null, "Refunded", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4444) },
                    { 3, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4453), "Account hacked", "In Progress", 3, "C111113", "E111113", null, "Investigating", null },
                    { 4, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4457), "Card not working", "Resolved", 1, "C111114", "E111114", null, "Card replaced", new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4460) },
                    { 5, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4463), "Unauthorized transaction", "Open", 2, "C111115", "E111111", null, "Pending investigation", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "MaxLoginAttempts", "5", "Maximum number of login attempts before account lockout", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5916), "E111111" },
                    { 2, "SessionTimeout", "30", "Session timeout duration in minutes", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5922), "E111111" },
                    { 3, "PasswordExpirationDays", "90", "Number of days before a password expires", new DateTime(2024, 9, 13, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5927), "E111111" },
                    { 4, "MinPasswordLength", "8", "Minimum password length for user accounts", new DateTime(2024, 9, 20, 16, 56, 31, 353, DateTimeKind.Local).AddTicks(5931), "E111111" },
                    { 5, "EnableTwoFactorAuth", "true", "Enables or disables two-factor authentication", new DateTime(2024, 8, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5935), "E111111" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 10, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5003), new DateTime(2024, 9, 15, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5011), "Approved for personal loan", "C111111", "E111111", null, 10000m, "Approved", 1 },
                    { 2, new DateTime(2024, 9, 12, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5025), new DateTime(2024, 9, 16, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5027), "Approved for home loan", "C111112", "E111112", null, 250000m, "Approved", 2 },
                    { 3, new DateTime(2024, 9, 14, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5034), new DateTime(2024, 9, 17, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5036), "Rejected due to insufficient credit score", "C111113", "E111113", null, 5000m, "Rejected", 1 },
                    { 4, new DateTime(2024, 9, 16, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5042), new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5174), "Approved for car loan", "C111114", "E111113", null, 20000m, "Approved", 3 },
                    { 5, new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5204), new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5206), "Pending approval", "C111115", "E111111", null, 15000m, "Pending", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "C111111", "Waiting for response", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4507), null },
                    { 2, 2, "C111112", "Good service", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4514), null },
                    { 3, 3, "C111113", "Please expedite", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4517), null },
                    { 4, 4, "C111114", "Resolved quickly", new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4520), null },
                    { 5, 5, "C111115", "Still no response", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4523), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "E111111", new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4574), "Investigated", "Manual" },
                    { 2, 2, "E111112", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4578), "Refund processed", "Automatic" },
                    { 3, 3, "E111113", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4582), "Ongoing investigation", "Manual" },
                    { 4, 4, "E111114", new DateTime(2024, 9, 15, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4585), "Card replaced", "Automatic" },
                    { 5, 5, "E111111", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4588), "Waiting for confirmation", "Manual" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Open", "Under review", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4630) },
                    { 2, 2, "Resolved", "Refunded", new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4633) },
                    { 3, 3, "In Progress", "Investigation ongoing", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4636) },
                    { 4, 4, "Resolved", "Card replaced", new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4640) },
                    { 5, 5, "Open", "Pending", new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(4643) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 9000m, 1, 1000m, new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5291), "Completed" },
                    { 2, 240000m, 2, 10000m, new DateTime(2024, 9, 15, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5297), "Completed" },
                    { 3, 4000m, 4, 1000m, new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5305), "Completed" },
                    { 4, 15000m, 5, 5000m, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5311), "Pending" },
                    { 5, 2000m, 3, 3000m, new DateTime(2024, 9, 17, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5317), "Completed" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "E111111", 1, 1000m, new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5385), "Bank Transfer" },
                    { 2, "E111112", 2, 10000m, new DateTime(2024, 9, 15, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5392), "Cheque" },
                    { 3, "E111113", 4, 1000m, new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5397), "Direct Debit" },
                    { 4, "E111114", 5, 5000m, new DateTime(2024, 9, 20, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5401), "Bank Transfer" },
                    { 5, "E111111", 3, 3000m, new DateTime(2024, 9, 17, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5405), "Cheque" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "C111111", "E111111", 6000m, 1000m, new DateTime(2024, 9, 19, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5623), (byte)1 },
                    { 2, 2, "C111112", "E111112", 14000m, 1000m, new DateTime(2024, 9, 18, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5632), (byte)2 },
                    { 3, 3, "C111113", "E111113", 24000m, 1000m, new DateTime(2024, 9, 17, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5650), (byte)3 },
                    { 4, 4, "C111114", "E111114", 34000m, 1000m, new DateTime(2024, 9, 16, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5656), (byte)4 },
                    { 5, 5, "C111115", "E111111", 45000m, 5000m, new DateTime(2024, 9, 15, 19, 56, 31, 353, DateTimeKind.Local).AddTicks(5669), (byte)5 }
                });
